...
class InitialConditions
{
  ...
  public:
    ...
    InitialConditions(
        const double a_amplitude_re, const double a_amplitude_im,
        const double a_omega, const std::array<double, CH_SPACEDIM> a_center,
    ...
    template <class data_t> void compute(Cell<data_t> current_cell) const
    {
        ...
        //        boosted_bh.compute_metric_background(metric_vars,
        //        current_cell); const data_t det_gamma =
