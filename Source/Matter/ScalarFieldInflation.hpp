  ...
  public:
    ...
    template <class data_t> struct Vars
    {
        ...
        void enum_mapping(mapping_function_t mapping_function)
        {
            ...
            VarsTools::define_enum_mapping(mapping_function, c_S, S);
            VarsTools::define_enum_mapping(mapping_function, c_psid, psi_dot);
            VarsTools::define_enum_mapping(mapping_function, c_psidd, psi_dotdot);
        }
    };
    ...
    //! The compute member which update the non-evolving vars at each point
    //! in the box
    template <class data_t>
    void compute(Cell<data_t> current_cell) const;
};

#include "ScalarFieldInflation.impl.hpp"
