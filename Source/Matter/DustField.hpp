...
#ifndef DUSTFIELD_HPP_
#define DUSTFIELD_HPP_
...
/*!
     ...
     the matter evolution terms. In this case, a dust field,
...
*/
template <class potential_t = DefaultPotential> class DustField
{
  protected:
  ...
  public:
    //!  Constructor of class DustField, inputs are the matter parameters.
    DustField(const potential_t a_potential) : my_potential(a_potential) {}
...
#include "DustField.impl.hpp"

#endif /* DUSTFIELD_HPP_ */
