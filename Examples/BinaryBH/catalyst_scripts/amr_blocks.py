...
renderView1.CameraPosition = [158.08172115703206, 212.13325123979374, 112.7252021311981]
renderView1.CameraFocalPoint = [32.00000000000007, 31.99999999999995, 32.0000000000001]
renderView1.CameraViewUp = [0.05928269610132273, -0.44249529710522584, 0.8948091830008877]
...
inputDisplay.Representation = 'AMR Blocks'
inputDisplay.ColorArrayName = ['POINTS', '']
...
pNG1.Writer.FileName = 'AMRBlocks_%.6ts%cm.png'
