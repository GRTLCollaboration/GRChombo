...
class SimulationParameters : public SimulationParametersBase
{
  public:
    ...
    void readParams(GRParmParse &pp)
    {
        ...
        pp.load("kfactor", initial_params.kfactor, 0.0); // CJ background SF
        // pp.load("kfactor", initial_params.kfactor, 0.08683215054); // CJ background SF
    ...
    double G_Newton;
    ScalarGauss::params_t initial_params;
